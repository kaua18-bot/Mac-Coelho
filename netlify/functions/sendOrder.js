/*
  ...
  - Função Netlify que envia pedidos por e-mail usando nodemailer.
  - Variáveis de ambiente necessárias (no painel Netlify → Site settings → Build & deploy → Environment):
      SMTP_HOST, SMTP_PORT, SMTP_SECURE ("true"|"false"), SMTP_USER, SMTP_PASS, SMTP_FROM, STORE_EMAIL
  - Esta é a cópia pronta para deploy (baseada em parts/03-netlify/sendOrder.js).
*/
